  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="{{route('films_favoris', ['id' => 1])}}">Mes favoris </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{route('films_top', ['id' => 1])}}">Top 5 series</a>
      </li>
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        ...
        movieEl.innerHTML +='<img src="'+src+'" alt="'+name+'">';
       
        movieEl.innerHTML += ' <div class="movie-info"><h3>'+name+'</h3><span class="'+getColor(vote_average)+'">'+vote_average+'</span></div>';
